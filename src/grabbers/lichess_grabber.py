...
class LichessGrabber(Grabber):
    def __init__(self, Firefox_url, Firefox_session_id):
        super().__init__(Firefox_url, Firefox_session_id)
        self.tag_name = None
        self.moves_list = {}
    ...
    def update_board_elem(self):
        try:
            ...
            self._board_elem = self.Firefox.find_element(By.XPATH,
                                                        '//*[@id="main-wrap"]/main/div[1]/div[1]/div/cg-container')
        except NoSuchElementException:
            try:
                # Try finding the board in the puzzles page
                self._board_elem = self.Firefox.find_element(By.XPATH, '/html/body/div[2]/main/div[1]/div/cg-container')
            except NoSuchElementException:
    ...
    def is_game_over(self):
        ...
        try:
            ...
            self.Firefox.find_element(By.XPATH, '//*[@id="main-wrap"]/main/aside/div/section[2]')
            ...
            try:
                ...
                game_over_window = self.Firefox.find_element(By.XPATH, '/html/body/div[2]/main/div[2]/div[3]/div[1]')
    ...
    def get_move_list(self):
        ...
        for move_element in children:
            ...
            self.Firefox.execute_script("arguments[0].setAttribute('data-processed', 'true')", move_element)
    ...
    def get_puzzles_move_list_elem(self):
        try:
            ...
            move_list_elem = self.Firefox.find_element(By.XPATH, '/html/body/div[2]/main/div[2]/div[2]/div')
    ...
    def get_normal_move_list_elem(self):
        try:
            ...
            move_list_elem = self.Firefox.find_element(By.XPATH, '//*[@id="main-wrap"]/main/div[1]/rm6/l4x')

            return move_list_elem
        except NoSuchElementException:
            try:
                # Try finding the normal move list when there are no moves yet
                self.Firefox.find_element(By.XPATH, '//*[@id="main-wrap"]/main/div[1]/rm6')
    ...
    def is_game_puzzles(self):
        try:
            ...
            self.Firefox.find_element(By.XPATH, "/html/body/div[2]/main/aside/div[1]/div[1]/div/p[1]")
    ...
    def click_puzzle_next(self):
        ...
        try:
            next_button = self.Firefox.find_element(By.XPATH, "/html/body/div[2]/main/div[2]/div[3]/a")
        except NoSuchElementException:
            try:
                next_button = self.Firefox.find_element(By.XPATH, '//*[@id="main-wrap"]/main/div[2]/div[3]/div[3]/a[2]')
            except NoSuchElementException:
                return

        # Click the continue training button
        self.Firefox.execute_script("arguments[0].click();", next_button)
    ...
    def make_mouseless_move(self, move, move_count):
        ...
        self.Firefox.execute_script(script)
